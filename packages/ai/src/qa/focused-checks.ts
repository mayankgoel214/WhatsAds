...
1. RANDOM TEXT: Is there any generated/random text in the BACKGROUND or SCENE that is NOT part of the product itself? ANY text, images, artwork, photos, or designs that are physically PRINTED ON or PART OF the product surface are fine — this includes product labels, brand names, custom text, photo collages, decorative patterns, names, dates, quotes, and any printed imagery on mugs, t-shirts, phone cases, greeting cards, posters, etc. Only flag text/graphics that are floating in the BACKGROUND SCENE and not part of the physical product. But random words, "8K", "QUALITY", gibberish text, watermarks in the scene = problem. EXCEPTION: A small "AI Generated by Clickkar" label at the very bottom is INTENTIONAL — ignore it.
